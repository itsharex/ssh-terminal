...
### 终端界面
![终端界面](./public/terminal.png)
![未连接状态](./public/terminal-noconnection.png)

### 会话管理
![会话管理](./public/session-manage.png)

### 设置页面
![设置页面 - 终端配置](./public/settings-1.png)
![设置页面 - 主题配置](./public/setting-2.png)
