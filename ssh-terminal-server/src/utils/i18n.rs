...
impl MessageKey {
    fn as_str(&self) -> &'static str {
        match self {
            ...
            MessageKey::SuccessGetLastUpdate => "api.success.get_last_update",
        ...
        "zh-CN": {
            "api": {
                ...
                "email": {
                    ...
                    "error_verify_code_expired": "验证码已过期，请重新获取验证码",
        ...
        "en": {
            "api": {
                "success": {
                    ...
                    "get_last_update": "Last update time retrieved successfully",
                ...
                "email": {
                    ...
                    "error_verify_code_expired": "Verification code expired, please get a new one",
